...
public class TestOne {
    ...
    public void storeData(OpenTsdb openTsdb,Integer flag){
        ...
        try{
            ...
            threadPoolExecutor.submit(new StoreThread(0L,10000000L,openTsdb,flag));
            threadPoolExecutor.submit(new StoreThread(10010000L,20000000L,openTsdb,flag));
            threadPoolExecutor.submit(new StoreThread(20010000L,30000000L,openTsdb,flag));
